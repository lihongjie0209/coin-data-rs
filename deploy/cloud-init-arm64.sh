...
ExecStart=/usr/local/bin/coin-data-rs --database /var/lib/coin-data-rs/market.duckdb --parquet-dir /var/lib/coin-data-rs/parquet --api-address 127.0.0.1:8081 --s3-prefix parquet/rust
Restart=always
RestartSec=5
TimeoutStopSec=30
